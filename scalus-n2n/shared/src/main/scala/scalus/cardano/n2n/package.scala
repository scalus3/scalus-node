...
/** Ouroboros-network Node-to-Node transport.
  ...
  * are M5+. Platform-neutral types live here; JVM-specific impls (NIO2 byte channel,
  * scheduled-executor timer) live under `scalus.cardano.n2n.jvm` in the jvm/ source set.
  */
package object n2n
